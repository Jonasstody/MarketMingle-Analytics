...
#initialize neccessary var h2h    
if 'search_input_h2h' not in st.session_state:
    st.session_state['search_input_h2h'] = 'n/a'
    
if 'ticker_symbol_h2h' or 'name_h2h' not in st.session_state:
    st.session_state['ticker_symbol_h2h'] = 'n/a'
    st.session_state['name_h2h'] = 'n/a'
...
if st.session_state.search_input != 'n/a' and st.session_state.search_input_h2h != 'n/a':
    ...
    if is_public and is_public_h2h:
        ...
        st.session_state['name_h2h'] = name_h2h
        st.session_state['ticker_symbol_h2h'] = ticker_h2h
        ...
        st.markdown(f'''
                ...
                ''', unsafe_allow_html=True) #3 columns on purpose, gives option to add vs. or something in the middle
        ...
        with general_tab:
            ...
            data_init = public.get_h2h_general(st.session_state.ticker_symbol)
            data_h2h = public.get_h2h_general(st.session_state.ticker_symbol_h2h)
            ...
            for kpi in general_content.keys():
                if kpi == 'ESG Risk':
                    ...
                    help_one, help_two, help_three = category.columns([3,1,3]) #to align helper text to middle
