    ...
    def get_ai_opinion(investor, ticker, company_name):
        ...
        try:
            ...
            request_string = f'''Pretend to be the famous investor {name}, and consider the following information 
                    ...
                    requesting more data or angles. Also do not comment on the sufficiency of the provided data. 
                    Never say in any way that you'd like to assess anything more about the company.
                    Keep the answer to a maximum of 3 to 4 sentences and only provide your viewpoint in your role.
